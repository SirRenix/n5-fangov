...
Pre-release: `n5-fangov version` prints the build and the dashboard shows a `beta`
badge until a release tag drops the suffix. Changes per version: [CHANGELOG.md](CHANGELOG.md).
